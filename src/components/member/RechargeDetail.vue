            ...
            <li class="list">
                ...
                <div class="list-content cf">
                    <div class="list-content-fl">
                       <p class="list-example">充值金额：￥1000</p>
                       <p class="list-example">实得金额：<span class="color-red">￥1000</span></p>
                       <p class="list-example">支付金额：￥1000</p>
                       <p class="list-example">支付方式：支付宝</p>
                    </div>
